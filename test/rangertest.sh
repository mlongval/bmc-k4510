...
# 9. delete to the trash: it moves, it does not destroy
out=$(R '~RANGER
~G~l~DD~y~q
' 1400)
...
# 10. a second file of the same name must not eat the first
...
echo "rangertest: OK (three columns, the column option, mkdir/yank/paste/rename, paste and trash both refuse to overwrite, exit lands in the browsed directory)"
