...
Press \texttt{RETURN} at \verb|Memory size ?| and you have 25\,599 bytes
free and a \verb|Ready| prompt.
...
\verb|@CD BASIC|, \verb|@MON|, \verb|@DUMP a note| --- and \verb|@BYE|
