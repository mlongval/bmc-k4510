...
\begin{aside}
\textbf{Not yet:} a graph unit on VICKe's bitmap layer; SYSTEM's own
\verb|Sqrt|/\verb|Sin|/\verb|Cos| routed to the unit (they are plain
Pascal in Mad Pascal's \texttt{system.pas}, and patching that file is a
step further into the checkout than the installer takes today).
\end{aside}
