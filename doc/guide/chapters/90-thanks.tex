...
(\verb|lib/fonts/font_8x8.c|) that got the text mode on its feet and
...
still be working inside the tradition rather than outside it. VICKe is
...
--- VICKe, SHEILA, the DMA engine, the ROM, K/OS, the Tube ULA, the
