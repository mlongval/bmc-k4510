...
reference for thirty years. The K4510's one to four sound chips are
that many copies of it (the 6581 model, as shipped in VICE~3.3).
...
demo exists because the art did.
...
latency measured in single frames. His initials are in the appliance's
name: the \textbf{BMC-K4510} is the K4510 on the bare-metal platform he
proved out (page~\pageref{sec:names}). It is the direct reason this
machine has a Pi port at all --- the route to the Pi was always meant to be
