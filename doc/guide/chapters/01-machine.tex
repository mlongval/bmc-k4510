...
\item \textbf{CPU: the 45GS10} --- the MEGA65's 45GS02 instruction set (a
  ...
  clock you choose yourself in the menu is never second-guessed; and if
  a program starves the sound anyway, the clock steps down one and
  stays there. \verb|BENCH| measures every step, for when you want the
  whole picture. \verb|INFO| reports the clock in force, read live, which is the only
