...
power-on. Two ways out. Hold any key through the first half second --- the
machine gives a moment's grace at the banner before it starts --- or, if
that moment is hard to catch, switch it off in the F7 menu under Shell:
