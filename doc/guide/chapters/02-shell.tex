...
All of this is in the F7 menu too, under Video: \emph{Resolution} shows
...
is the second parameter. Two of the modes are live only: what reaches
\texttt{k4510.cfg} is never smaller than 320$\times$240, so a machine that
has been switched off and on again never comes back somewhere hard to
steer out of.
