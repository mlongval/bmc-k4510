...
CP/M~2.2 on a Z80 co-processor (RunCPM, on the host --- the boot banner
cheerfully measures the Z80 in \emph{gigahertz}), and the \verb|A0>|
prompt that defined a decade appears.
...
MBASIC, adventures) work today. Full-screen software --- WordStar's
editor, ZDE --- needs terminal emulation the console does not have yet.
