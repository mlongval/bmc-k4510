...
\texttt{\$0800-\$CFFF} & user   & 50\,KB for programs (the ROM banks away at launch)\\
...
\texttt{INFO} and \texttt{TIME} already run from bank 1), and the shell
pages the right bank in around each call. System calls work throughout:
