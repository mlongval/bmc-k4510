...
\screen{shots/forth.png}{A Forth session: arithmetic, a new word, and
\texttt{SEE} showing its compiled code.}
...
\section{Manners}
The dictionary has about 12.8\,KB free for your words. \verb|BYE| returns
to the shell with the screen and the session exactly as you left them.

\begin{aside}
No file words yet: Forth source lives in \texttt{/FORTH} but must be typed.
