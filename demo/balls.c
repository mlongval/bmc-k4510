/* K4510 demo: 15 bouncing balls. 128-sprite engine, 4 bpp sprites with
...
void main(void)
{
    ...
    text8_print(TEXTMAP, 80, 1, 0, "K4510  VICKY: 15 x 32x32 4bpp sprites, 15 palette banks, SHEILA sky");
